...
$db_name = 'логин_bdname'; // Замените на имя базы данных, обычно начинается с вашего логина
$db_user = 'логин_bduser'; // Замените на пользователя БД (обычно также начинается с логина)
